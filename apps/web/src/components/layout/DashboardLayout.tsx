...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  return (
    <div className="flex flex-col h-screen h-[100dvh] w-full overflow-hidden bg-slate-50 text-slate-900 antialiased font-sans relative">
      ...
      <div className="flex flex-1 min-h-0 w-full overflow-hidden relative">
        ...
        <div
          ...
          className="flex-1 flex flex-col h-full min-w-0 overflow-y-auto overflow-x-hidden"
        >
          <TopBar
            onRefresh={onRefresh}
          ...
          <main
            ...
            className={`flex-1 p-4 sm:p-6 md:p-8 max-w-[1600px] w-full mx-auto transition-all duration-200 ${
              isNavigating
